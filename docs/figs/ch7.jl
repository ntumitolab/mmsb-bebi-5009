...
@time "Solve problem" sol = solve(prob707a, FBDF(), callback=cbs)
...
@time "Solve problem" sol717 = solve(prob717, FBDF())
...
@time "Solve problem" sol721 = solve(prob721, FBDF())
...
@time "Solve problem" sol728 = solve(prob728, FBDF())
...
@time "Solve problem" sol731 = solve(prob731, FBDF())
